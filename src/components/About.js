...
const About = () => {
  return (
    <div className="p-10 min-h-screen">
      <h1 className="text-5xl font-bold text-gray-700">About FONQP Group</h1>
      {/* add some gap */}
      ...
      <div className="flex flex-col md:flex-row mt-5">
        ...
        <div className="md:w-1/4 mt-5 md:mt-0 md:ml-10">
          <img src="QuEd.jpg" alt="FONQP Group" className="w-full h-auto" />
        </div>
      </div>
      {/* now put image on left and text on right */}
      <div className="flex flex-col md:flex-row mt-5">
        <div className="md:w-1/4 mt-2">
          <img src="FONQP Lab.jpeg" alt="FONQP Group" className="w-full h-auto" />
        </div>
